...
%----------------------------------------------------------------
% Aqui vai a bibliografia. Existem quatro estilos de citação: use
...
% 'ppgcc-apa-ptbr' para citações do tipo Silva F. (2019) se o 
% volume estiver sendo escrito em português ou apenas 'apalike'
% para o mesmo estilo APA, no entanto, para quando o volume
% estiver sendo escrito em inglês
%----------------------------------------------------------------
%\bibliographystyle{ppgcc-alpha} 
%\bibliographystyle{ppgcc-num}
%\bibliographystyle{apalike} # estilo APA em inglês
\bibliographystyle{ppgcc-apa-ptbr} # estilo APA em português
