...
% No momento a classe suporta apenas a impressão em frente e
% verso.
\documentclass[portuguese]{pucrs-ppgcc}
...
% Este pacote sofreu muitas alterações recentemente. Neste caso, é
% melhor fazer justiça com versões um pouco mais antigas.
%\RequirePackage[colorlinks=true,anchorcolor=,citecolor=,%
%                filecolor=,linkcolor=,menucolor=,runcolor=,%
%                urlcolor=blue]{hyperref}[2009/10/09]
%----------------------------------------------------------------
...
% Ambiente para inserir algoritmos.
%\usepackage{algorithm}
% Para formatar os algoritmos propriamente ditos.
...
À erat sed, diam voluptua at vero, eos et accusam et justo duo
...
% organização e gerenciamento do documento, separe-o em arquivos,
...
%----------------------------------------------------------------
% E aqui vão os "capítulos" de anexos. No caso, cada anexo deve
