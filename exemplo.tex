...
% ATENÇÃO: Necessário para o estilo bibliográfico 'ppgcc-apalike'.
...
% 'ppgcc-apalike' para citações do tipo Silva F. (2019). Caso
% decida usar o 'ppgcc-apalike', lembre-se de usar o pacote 'natbib'
% para corrigir a formatação dos parênteses.
%----------------------------------------------------------------
