...
% Autor (OBRIGATÓRIO)
%----------------------------------------------------------------
\author[a,b,c]{Atila Leites Romero}
\author[a,b]{Avelino Francisco Zorzo}
{\tiny
\affil[a]{Pontifical Catholic University of RS (PUCRS), Porto Alegre, Brazil}
\affil[b]{Instituto Nacional de Ci\^{e}ncia e Tecnologia Forense (INCT Forense), Brazil}
\affil[c]{Setor T\'{e}cnico-Cient\'{i}fico, Superintend\^{e}ncia da Pol\'{i}cia Federal, Porto Alegre, RS, Brazil}
}
