...
%================================================================
% CONTRA CAPA DA BIBLIOTECA não está sendo inserida ao final do volume 
% automaticamente quando é Dissertação ou Tese, mas está implementada.
% Basta apenas descomentar a linha abaixo:
%----------------------------------------------------------------
%\replacecontracapa
