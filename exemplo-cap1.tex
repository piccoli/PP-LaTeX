...
dolor sit amet lorem ipsum~\cite{NAGAPACKING07}. O algoritmo na
Figura~\ref{fig:algo} mostra este processo.
...
\begin{center}
      ...
      \begin{algorithmic}[1]
         ...
         \STATE \COMMENT{\texttt{table} is a global object to contain the best matching templates for each pair $\left(i,j\right)$}
           \IF{$table\left[i,j\right].memoized$}
...
dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod
tempor invidunt ut labore et dolore magna aliquyam erat sed diam
voluptua at vero~\cite{BRIANPL04}.
