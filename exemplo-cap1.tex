...
\begin{center}
      ...
      \begin{algorithmic}[1]
         ...
         \RETURN $minerror$
      \end{algorithmic}
      \caption[A figure with an alternate, shorter caption]%
        {\label{fig:algo}This is another figure with a very long
            caption. However, this time we will actually use the shorter
            version.}%
\end{center}
\end{figure}
